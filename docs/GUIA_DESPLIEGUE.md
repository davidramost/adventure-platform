...
# === JWT ===
jwt.secret=${JWT_SECRET:TfgAdventureSecretKeyForJwtTokenGeneration2026MustBeAtLeast256BitsLong!!}
...
docker run -p 8080:8080 \
  ...
  -e JWT_SECRET=TfgAdventureSecretKeyForJwtTokenGeneration2026MustBeAtLeast256BitsLong!! \
  tfg-backend
```
