                    ...
                    {cart.length === 0 ? (
                        <div className="bg-surface rounded-2xl border border-[#333] p-12 text-center shadow-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24"
                                ...
                                strokeLinejoin="round" className="text-white mx-auto mb-6">
                                <circle cx="9" cy="21" r="1"></circle>
                                <circle cx="20" cy="21" r="1"></circle>
                                <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
                            </svg>
                            <h2 className="text-white text-2xl mb-4">Tu carrito está vacío</h2>
                            <p className="text-gray-400 mb-8">Parece que aún no has añadido ningún producto de nuestra
                                tienda.</p>
                            <Link to="/tienda"
                        ...
                        <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <div className="lg:w-2/3">
                                <div className="bg-surface rounded-2xl border border-[#333] overflow-hidden shadow-lg">
                                    <div
                                        className="p-6 hidden sm:grid grid-cols-12 gap-4 border-b border-white/10 text-gray-400 text-sm font-medium">
                            ...
                            <div className="lg:w-1/3">
                                <div className="bg-surface rounded-2xl border border-[#333] p-6 shadow-lg sticky top-6">
                                    <h2 className="text-white text-xl font-bold mb-6 border-b border-white/10 pb-4">Resumen
                                        de compra</h2>
                                    ...
                                    <div
                                        className="flex justify-between items-center border-t border-white/10 pt-4 mb-8">
