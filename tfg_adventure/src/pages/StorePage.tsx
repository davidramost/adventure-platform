    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 bg-surface-dark">
                {/* Toolbar */}
                <div
                    className="flex flex-wrap justify-between items-center px-[5%] py-6 bg-gradient-to-br from-primary-light to-primary-dark border-t border-white/10">
                ...
                <section className="px-[5%] py-8 lg:py-12">
                    {loading ? (
                            ...
                            {filteredProductos.map(producto => (
                                <article key={producto.id_producto}
                                    ...
                                    <Link to={`/producto/${producto.id_producto}`}
                                        ...
                                        />
                                        <div
                                            className="absolute top-3 left-3 bg-primary-dark text-white text-xs font-bold px-3 py-1 rounded-full">
                                            {producto.categoria}
                                        </div>
                                        {/* Etiqueta de stock */}
                                        {producto.stock === 0 && (
                                            <div
                                                className="absolute top-3 right-3 bg-red-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                                                Sin stock
                                            </div>
                                        )}
                                    </Link>
                                    ...
                                    <div className="p-5 flex flex-col flex-1">
                                        ...
                                        <div className="flex items-center justify-between mt-auto">
                                            <span
                                                className="text-white font-bold text-xl">{producto.precio.toFixed(2)} €</span>
                                            <button
                        ...
                        <p className="text-white text-center py-12 text-lg">No se encontraron productos que coincidan
                            con tu búsqueda.</p>
                    )}
                </section>
            </main>
