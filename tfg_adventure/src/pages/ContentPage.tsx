        ...
        <div className="relative w-full h-[340px] md:h-[440px] overflow-hidden">
          ...
          {ruta.imagen_url ? (
            <img
              ...
              onError={(e) => { e.currentTarget.src = '/Img/Icons/sin-imagen.png'; }}
          ...
          <div className="absolute bottom-0 left-0 right-0 px-[5%] pb-8">
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold border mb-3 ${difficultyBadge}`}>
        ...
        <div className="mx-auto px-[5%] py-10">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 min-w-0 space-y-8 order-2 lg:order-1">
              ...
              {/* Comments */}
              <section className="bg-white/5 border border-white/10 rounded-2xl p-6">
                <h2 className="text-white font-semibold text-lg mb-6">Comentarios ({resenas.length})</h2>
                ...
                {usuario ? (
                  <>
                    ...
                    <form onSubmit={handleSubmitReview} className="mb-8 bg-white/5 rounded-xl p-5 border border-white/10">
                      <div className="mb-4">
                        <label className="block text-white text-sm font-medium mb-2">Puntuación:</label>
                      ...
                      <div className="mb-4">
                        <label htmlFor="comentario" className="block text-white text-sm font-medium mb-2">Tu opinión:</label>
                        <textarea
                          id="comentario"
                          rows={4}
                          value={comentario}
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex gap-0.5">
                              {[1, 2, 3, 4, 5].map(i => (
                                <span key={i} className={`text-lg ${i <= resena.puntuacion ? 'text-yellow-400' : 'text-gray-600'}`}>★</span>
                              ))}
                            </div>
                          </div>
            ...
            <aside className="lg:w-80 xl:w-96 flex-shrink-0 space-y-5 order-1 lg:order-2">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-4">
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${difficultyBadge}`}>
                    {ruta.dificultad.toUpperCase()}
                  </span>
                </div>
              </div>
