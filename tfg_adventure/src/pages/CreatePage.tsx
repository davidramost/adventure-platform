      ...
      <main>
        <section className="bg-gradient-to-br from-primary-light to-primary-dark py-12">
          <div className="mx-auto px-[5%] text-left">
            <h1 className="text-white text-[30px] font-bold italic mb-8 tracking-wider">CREAR NUEVA RUTA</h1>
            ...
            <form onSubmit={handleSubmit} className="max-w-[800px] mx-auto">
              ...
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="flex-1">
                  <label htmlFor="latitudUbicacion" className="block text-white text-sm font-medium mb-2">Latitud</label>
                  <input
                    type="number" step="any" id="latitudUbicacion" name="latitudUbicacion" value={form.latitudUbicacion} onChange={handleChange}
                ...
                <div className="flex-1">
                  <label htmlFor="longitudUbicacion" className="block text-white text-sm font-medium mb-2">Longitud</label>
                  <input
                    type="number" step="any" id="longitudUbicacion" name="longitudUbicacion" value={form.longitudUbicacion} onChange={handleChange}
