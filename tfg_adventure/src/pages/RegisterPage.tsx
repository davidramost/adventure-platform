        ...
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex flex-1 lg:flex-row min-h-0">
                ...
                <div className="hidden lg:flex lg:w-[42%] xl:w-[38%] relative flex-col shrink-0">
                    ...
                    />
                    <div
                        className="absolute inset-0 bg-linear-to-b from-primary-dark/70 via-primary-dark/60 to-primary-dark/90" />
                ...
                <div
                    className="flex flex-col flex-1 bg-linear-to-br from-primary-light to-primary-dark overflow-y-auto">
                    ...
                    <main className="flex-1 flex items-center justify-center py-12 lg:py-16 px-6 lg:px-10 xl:px-16">
                        <div className="w-full max-w-xl">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                {/* ── Sección: Cuenta ── */}
                                <div className="mb-2">
                                    <p className="text-white/50 text-xs uppercase tracking-widest mb-4 font-semibold">Datos
                                        de acceso</p>

                                    <div className="mb-5">
                                        <label htmlFor="nombre_usuario"
                                            className="block text-white text-sm mb-2 font-medium">Nombre de
                                            usuario</label>
                                   ...
                                   placeholder:text-[#aaa] focus:border-white focus:bg-white/15 disabled:opacity-50 disabled:cursor-not-allowed"
                                        ...
                                        <div>
                                            <label htmlFor="confirmar_password"
                                                className="block text-white text-sm mb-2 font-medium">Confirmar
                                                contraseña</label>
                                            <div className="relative">
                                ...
                                <div className="my-8 border-t border-white/20 pt-6">
                                    <p className="text-white/50 text-xs uppercase tracking-widest mb-5 font-semibold">Foto
                                        de perfil <span className="normal-case">(opcional)</span></p>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                                        <div>
                                            <label htmlFor="nombre"
                                                className="block text-white text-sm mb-2 font-medium">Nombre</label>
                                            <input
                                                type="text"
                                                id="nombre"
                                 ...
                                 placeholder:text-[#aaa] focus:border-white focus:bg-white/15 disabled:opacity-50 disabled:cursor-not-allowed"
                                        ...
                                        <div>
                                            <label htmlFor="apellido"
                                                className="block text-white text-sm mb-2 font-medium">Apellido</label>
                                            <input
                                                type="text"
                                                id="apellido"
                                 ...
                                 placeholder:text-[#aaa] focus:border-white focus:bg-white/15 disabled:opacity-50 disabled:cursor-not-allowed"
                                    ...
                                    <div className="mb-5">
                                        <label htmlFor="domicilio"
                                            className="block text-white text-sm mb-2 font-medium">Domicilio</label>
                                        <input
                                            type="text"
                                            id="domicilio"
                               ...
                               placeholder:text-[#aaa] focus:border-white focus:bg-white/15 disabled:opacity-50 disabled:cursor-not-allowed"
                                    ...
                                    <div className="mb-5">
                                        <label htmlFor="fact_domicilio"
                                            className="block text-white text-sm mb-2 font-medium">Domicilio de
                                            Facturación</label>
                                        <input
                                            type="text"
                                            id="fact_domicilio"
                           ...
                           hover:bg-gray-200 transition-colors flex items-center justify-center gap-3 disabled:opacity-60 disabled:cursor-not-allowed"
                                >
                                    {loading ? (
                                        ...
                                        <>
                                            <img src="/Img/Icons/arrow_right_black.png" alt="Registrar"
                            ...
                            <div className="mt-8 flex flex-col items-center gap-3">
                                <Link to="/login"
                                    className="text-white/70 hover:text-white no-underline text-sm transition-colors">
                                    ¿Ya tienes cuenta? <span className="underline">Inicia sesión</span>
                                </Link>
                                <Link to="/"
                                    className="text-white/50 hover:text-white no-underline text-xs transition-colors inline-flex items-center gap-2 lg:hidden">
