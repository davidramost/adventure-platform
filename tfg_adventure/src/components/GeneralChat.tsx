...
export default function GeneralChat() {
    ...
    return (
        <section className="py-8 lg:py-16">
            ...
            <div className="max-w-3xl mx-auto rounded-2xl overflow-hidden shadow-lg border border-gray-200 flex flex-col"
                style={{ height: '520px' }}>
                ...
                <div className="bg-white border-t border-gray-200 px-4 py-3">
                    {usuario ? (
                        ...
                        <p className="text-center text-sm text-gray-400 py-1">
                            <a href="/login" className="text-primary-dark font-medium hover:underline">Inicia sesión</a> para participar en el chat
                        </p>
                    )}
                    {error && (
